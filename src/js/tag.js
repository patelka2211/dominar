 ...
 */
export function newTag(tagName, attributes) {
    ...
    for (const attributeName in attributes) {
        if (Object.prototype.hasOwnProperty.call(attributes, attributeName)) {
            ...
            if ((["string", "number"].includes(typeof attributeValue) ||
                attributeValue === true) &&
                ...
                if (["children", "eventListeners"].includes(attributeName))
                    ...
                    console.warn(`The ${attributeName} attribute has been removed from the tag because its value was an object, only string, number, or true values are allowed for this attribute.`);
            }
        }
    }
    return {
